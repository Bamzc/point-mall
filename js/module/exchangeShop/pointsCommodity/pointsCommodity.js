define(["util","template","text!js/module/exchangeShop/pointsCommodity/pointsCommodity.art","common","store"],function(util,template,art,common,store){
	...
	return {
		...
		render : function(){
			...
			util.requestHtml("/exchangeShop/pointsCommodity.html",function(html){
